                                                                                                                        ...
                                                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                                                            ...
                                                                                                                            <div id="isi_sturk">
                                                                                                                                ...
                                                                                                                                <div class="card-body">
                                                                                                                                    ...
                                                                                                                                    <h4 class="card-title text-center">NOTIFIKASI PEMBELIAN BARANG KEPADA SUPPLIER</h4>
                                                                                                                                    <p>Klik cek detail pesanan untuk melihat detail pesanan dan menentukan tanggal kirim</p>
                                                                                                                                    <h2 style=" width: 240px; color: rgb(0, 0, 0); "><strong>[ {{ $nama ?? '' }}  ]</strong></h2>

                                                                                                                                    <h4>Email         : {{ $email ?? '' }} </h4>
                                                                                                                                    <h4>Nama Supplier : {{ $nama ?? '' }} </h4>
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td align="center"
                                                                                                                                            ...
                                                                                                                                            <a href="{{ $verify_link ?? '' }}"
                                                                                                                                               ...
                                                                                                                                               target="_blank">Cek Detail Pesanan</a>
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </tbody>
                                                                                                                            </table>
