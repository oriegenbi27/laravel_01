                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="input-group col-sm-4">
                                ...
                                <input value="{{$purchasing->data->supplier}}" type="text" name="supplier" id="inputserch" class="form-control" placeholder="Tambah Suppplier">
