    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="ibox-content border ">
                <form action="{{url('return/search')}}" method="POST" enctype="multipart/form-data">
                    <dl class="row mb-0">
            ...
            <form action="{{route('Return ERP')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @if (empty($purchasing))
                            ...
                            <div class="form-group row has-success">
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" value="" name="date"
                                        style="border-radius: 4px;height: 1.6rem;">
                                    @else
                                    <input type="text" class="form-control" value="{{$purchasing->data->tgl_terima}}"
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="records" name="id" id="tr{{$detail->id}}" data-id="{{$detail->id}}">
                            ...
                            <td><input  id="actual{{$detail->id}}" type="number"  data-key="{{$detail->id}}" min="0" max="{{$detail->qty}}" value="{{$detail->actual}}" class="form-control" name="actual[]"
                                    style="max-width:100px;border-radius:4px;height: 1.6rem; background-color: transparent; border-top:none;border-left:none;border-right:none; border-bottom:none; width:50px;"  disabled></td>
                            <td><input value="{{$detail->return}}"  id="return{{$detail->id}}" type="number"  data-key="{{$detail->id}}" min="0" max="{{$detail->qty - $detail->actual}}" class="form-control" name="return[]"
