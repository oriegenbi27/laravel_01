                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group has-success col-sm-8">
                                    ...
                                    <input style="height: 1.6rem;" autocomplete="off" type="text" class="form-control"
                                        name="code" placeholder="Input Code Barang" required>
                                </div>
                                &nbsp;
                                <div class="input-group has-success col-sm-8">
                                    <div class="col-sm-4 text-sm-right">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group has-success col-sm-8">
                                    ...
                                    <input style="height: 1.6rem;" onchange="return calprice(this)" name="harga" id="harga" type="text" class="form-control" aria-label="Harga">
                                </div>
                                &nbsp;
                                <div class="input-group has-success col-sm-8">
                                    <div class="col-sm-4 text-sm-right">
                                    ...
                                    <input style="height: 1.6rem;" onchange="return calprice(this)" type="text" name="diskon" id="diskon" class="form-control" aria-label="Diskon">
                                </div>
                                &nbsp;
                                <div class="input-group has-success col-sm-8">
                                    <div class="col-sm-4 text-sm-right">
                                    ...
                                    <input style="height: 1.6rem;" type="number" name="berat" id="berat" class="form-control" aria-label="Berat">
                                </div>
                                &nbsp;
                                <div class="input-group has-success col-sm-8">
                                    <div class="col-sm-4 text-sm-right">
                                    ...
                                    <input style="height: 1.6rem;" type="text" name="stock" id="stock" class="form-control" aria-label="Stock">
                                </div>
                                &nbsp;
                                <div class="input-group has-success col-sm-8">
                                    <div class="col-sm-4 text-sm-right">
                                    ...
                                    {{-- <input style="height: 1.6rem;" type="text"  aria-label="Unit"> --}}
                                ...
                                <div class="input-group has-success col-sm-8">
                                    ...
                                    <input style="height: 1.6rem; background-color: transparent;" onchange="return calprice(this)" readonly name="totalharga" id="totalharga" type="text" class="form-control" aria-label="Harga">
                                </div>
                                &nbsp;
                                <div class="input-group has-success col-sm-8">
                                    <div class="col-sm-4 text-sm-right">
                                    ...
                                    <input style="height: 1.6rem; background-color: transparent;"  name="ppn" id="ppn" type="number" class="form-control" aria-label="Harga">
                                </div>
                            </div> 
                        </div>
