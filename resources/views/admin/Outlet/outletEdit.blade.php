                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group has-success col-sm-8">
                                    ...
                                    <input value="{{$outlet->data->nama}}" style="height: 1.6rem;" autocomplete="off" type="text" class="form-control"
                                ...
                                <div class="input-group has-success col-sm-8">
                                    ...
                                    <input value="{{base64_decode($outlet->data->password)}}" style="height: 1.6rem;" autocomplete="off" type="password" class="form-control"
                                ...
                                <div class="input-group has-success col-sm-8">
                                    ...
                                    <textarea class="form-control" name="alamat" id="alamat">{{$outlet->data->alamat}}</textarea>
                                </div>
                                &nbsp; 
                                <div class="input-group has-success col-sm-8">
                                    <div class="col-sm-5 text-sm-right">
                                    ...
                                    <input value="{{$outlet->data->tgl_awal}}" style="height: 1.6rem;"  name="awal" id="awal" type="date" class="form-control" >
                                </div>
                                &nbsp; 
                                <div class="input-group has-success col-sm-8">
                                    <div class="col-sm-5 text-sm-right">
                                    ...
                                    <input value="{{$outlet->data->tgl_akhir}}" style="height: 1.6rem;"  name="akhir" id="akhir" type="date" class="form-control">
                                </div>
                                &nbsp; 
                            </div> 
