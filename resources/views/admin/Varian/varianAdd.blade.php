                    ...
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="input-group col-sm-6">
                                ...
                                <input type="text" class="form-control" name="nama" placeholder="Nama Varian" required>
                            </div>
                            ...
                            <div class="input-group col-sm-6">
                                ...
                                <input type="text" class="form-control" name="code" placeholder="Code Varian" required>
                            </div>
                        </div>
                        <div class="form-group row">
