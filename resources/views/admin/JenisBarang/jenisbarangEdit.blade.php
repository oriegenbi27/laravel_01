...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Jenis Barang/Produk Edit</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{url('/')}}">Home</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('List Jenis Barang')}}">Jenis Barang</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>Jenis Barang Edit</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox border">
                ...
                <div class="ibox-content border ">
                    <form action="{{route('Edit Jenis Barang' , $JenisBarang->data->id)}}" method="POST" enctype="multipart/form-JenisBarang">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="input-group col-sm-6">
                                ...
                                <input type="text" class="form-control" name="nama" value="{{$JenisBarang->data->nama}}" placeholder="Nama Satuan" required>
                            </div>
                            ...
                            <div class="input-group col-sm-6">
                                ...
                                <input type="text" class="form-control" name="code" value="{{$JenisBarang->data->code}}" placeholder="Code Satuan" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 font-weight-bold col-form-label">Keterangan</label>
                            <div class="col-sm-12">
                                <textarea class="form-control" name="keterangan" id="" cols="30" rows="10">{{$JenisBarang->data->keterangan}}</textarea>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 col-sm-offset-2">
                                <input type="hidden" name="id" value="{{$JenisBarang->data->id}}">
