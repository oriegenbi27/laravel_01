...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Jenis Barang/Produk Add</h2> 
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{url('/')}}">Home</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{url('/jenis-barang')}}">Jenis Barang</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>Jenis Barang Add</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox border">
                <div class="ibox-title">
                    <h5>Jenis / Barang <small></small></h5>
                    <div class="ibox-tools">
                        <a class="btn " href="{{url('/jenis-barang')}}" title="back">
                ...
                <div class="ibox-content border ">
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group col-sm-6">
                                <label class="col-sm-12 font-weight-bold col-form-label">Code Jenis Barang</label>
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fa fa-file-text"></i></span>
                                </div>
                                <input type="text" class="form-control" name="code" placeholder="Code Jenis Barang" required>
                            </div>
                        </div>
                        <div class="form-group row">
