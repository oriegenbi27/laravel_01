...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{url(route('Warehouse ERP'))}}">Warehouse</a>
            </li>
                            ...
                            <dd class="mb-1">
                                <div class="form-group row has-success">
                                    <div class="input-group col-sm-10">
                                        ...
                                        @else
                                        <input id="ponomor" type="text" class="typeahead form-control"
                                            value="{{$purchasing->data->code}}" name="ponomor"
                                            style="none;border-right:none;height: 1.6rem;" required>
                                        ...
                                        <div class="input-group-prepend">
                                            <button id="cari" class="btn input-group-text button-add"
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="records" name="id" id="tr{{$detail->id}}" data-id="{{$detail->id}}">
                            ...
                            <td><input style="border-top:none;border-left:none;border-right:none; border-bottom:none;  background-color: transparent;" name="idpurchasing[]" value="{{$detail->id_purchasing}}" readonly></td>
                            ...
                            <td>@if($purchasing->data->status==4)
                                <input  style="border-top:none;border-left:none;border-right:none; border-bottom:none; width:50px; background-color: transparent;" name="qtybarang[]" value="{{$detail->return}}" readonly></td>
                                @else
                                <input  style="border-top:none;border-left:none;border-right:none; border-bottom:none; width:50px; background-color: transparent;" name="qtybarang[]" value="{{$detail->qty}}" readonly></td>
                            @endif
                            <td>@if ($purchasing->data->status==4)
                                <input  value="" id="actual{{$detail->id}}" type="number"  data-key="{{$detail->id}}" min="0" max="{{$detail->return}}" class="form-control" name="actual[]"
                                style="max-width:100px;border-radius:4px;height: 1.6rem;">
                                @else
                                <input  value="{{$detail->actual}}" id="actual{{$detail->id}}" type="number"  data-key="{{$detail->id}}" min="{{$detail->actual}}" max="{{$detail->qty}}" class="form-control" name="actual[]"
                                style="max-width:100px;border-radius:4px;height: 1.6rem;">
                            </td>@endif
